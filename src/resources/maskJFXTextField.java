 ...
 * @author Gabriel
 */
public class maskJFXTextField {
    
    public static void mascaraNumeroInteiro(JFXTextField textField){
    ...
    public static void mascaraNumero(JFXTextField textField){
    ...
    public static void mascaraCEP(JFXTextField textField){
    ...
    public static void mascaraData(JFXTextField textField){
    ...
    public static void mascaraCPF(JFXTextField textField){
    ...
    public static void mascaraEmail(JFXTextField textField){
    ...
    public static void mascaraTelefone(JFXTextField textField){
